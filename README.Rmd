...
The goal of sfweight is to create a tidier and streamlined interface to the spdep package. 

The intention behind sfweight is implement a simpler, but stricter workflow that enables the creation of neighbors, spatial weights, and spatially lagged variables. 

sfweight uses sf objects whereas spdep is more flexible with the types of input objects. 
